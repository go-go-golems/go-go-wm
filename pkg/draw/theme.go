...
// Palette ports C from the prototype (pbui-shell.jsx:30-36).
var (
	Paper    = rgb(0xe9, 0xe2, 0xd0)
	Pane     = rgb(0xf5, 0xf0, 0xe3)
	PaneAlt  = rgb(0xef, 0xe9, 0xd9)
	Ink      = rgb(0x33, 0x30, 0x2a)
	Faint    = rgb(0x7a, 0x73, 0x65)
	Sage     = rgb(0xa9, 0xbd, 0xa2)
	Blue     = rgb(0x9c, 0xb4, 0xc2)
	Rose     = rgb(0xcf, 0xa0, 0x8f)
	Mustard  = rgb(0xd3, 0xb5, 0x6a)
	Lavender = rgb(0xb3, 0xab, 0xc4)
	Mint     = rgb(0xb7, 0xc9, 0xb3)
	Red      = rgb(0xb0, 0x56, 0x3f)
	Sel      = rgb(0xf4, 0xe6, 0xb8)
	Field    = rgb(0xfb, 0xf8, 0xef)
)
